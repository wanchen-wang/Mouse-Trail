...
from PyQt6.QtWidgets import QApplication, QWidget # 基本窗口类
...
class MouseTrail(QWidget):
    ...
    def update_trail(self):
        ...
        if current_global_pos != self.last_pos:
            ...
            for _ in range(5): 
                ...
                self.points.append([QPointF(base_x, base_y), 180, r_size, vx, vy, shape_type])
    ...
    def paintEvent(self, event):
        ...
        for point, alpha, size, vx, vy, shape_type in self.points:
            green_channel = int(215 * (alpha / 255))
            color = QColor(255, green_channel, 0, alpha)
